...
GAME_PATH=~/Steam/steamapps/common/OpenTTD
cd $GAME_PATH

AUTO_SAVE_PATH="/home/steam/.local/share/openttd/save/autosave"
echo "loading autosave..."
SAVED_GAME=${AUTO_SAVE_PATH}/`ls -rt ${AUTO_SAVE_PATH} | tail -n1`
./openttd -D -g "${SAVED_GAME}" -x
#./openttd -D -g ~/China.scn -x
```
...
client_name = 
server_password = 233
rcon_password = d8sdoiwesdoifj2e
admin_password = 
default_company_pass = 
server_name = MidyMidyOpenTTD2333
connect_to_ip = 
network_id = 4f51d177075b4a220fdffa40e4d04185
...
[company]
engine_renew = true
engine_renew_months = 12
engine_renew_money = 10000
